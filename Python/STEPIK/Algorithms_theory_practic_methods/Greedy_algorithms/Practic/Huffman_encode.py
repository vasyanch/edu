'''
    Данный код реализует кодирование Хаффмана строки состоящей из латинских строчнных букв
     и размером строки  <= 10^4 символов.В первой строке программа выводит количество различных букв k,
     встречающихся в строке и размер получившейся закодированной строки. В следующих k строках
     выводятся коды букв в формате "letter: code". В последней строке пишется закодированная строка.
'''
